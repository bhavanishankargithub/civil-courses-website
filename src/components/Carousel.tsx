    ...
    <section className="carousel-section">
      <div className="carousel-container">
        <div className="carousel-header">
          <h2 className="carousel-title">Inspiring Projects</h2>
          <p className="carousel-subtitle">
            Discover remarkable engineering achievements from around the world
          </p>
        </div>
            ...
            {inspiringImages.map((image, index) => (
              ...
              >
                ...
                <div className="carousel-content">
                  ...
                  <p className="carousel-slide-description">{image.description}</p>
                </div>
              </div>
            ))}
          </div>
