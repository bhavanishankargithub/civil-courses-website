...
export const courses: Course[] = [
  {
    ...
    full_description:
      "This comprehensive course covers the fundamental principles of structural analysis, including force systems, equilibrium, trusses, frames, and influence lines. Learn to analyze various structural systems and understand load distribution, deflections, and stability. Perfect for aspiring civil engineers and professionals looking to strengthen their foundation.",
    image_url:
